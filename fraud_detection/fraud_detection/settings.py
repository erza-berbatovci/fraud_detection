...
SECRET_KEY = 'django-insecure-^zf=l$$m+rs10#j8n%xg_frif_6x%)7aktyjz408*4vj_-u#*f'
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,  # Sigurohuni që kjo është True për të mundësuar Django të kërkojë në dosjet e aplikacioneve
        'OPTIONS': {
            'context_processors': [
